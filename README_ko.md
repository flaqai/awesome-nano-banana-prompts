...
![Awesome Nano Banana Pro Prompts — Flaq.ai 오픈소스 프롬프트 플레이북](assets/hero.png)
...
브랜드 광고, 이커머스 제품 이미지, 소셜 콘텐츠, 인포그래픽, UI, 캐릭터, 스토리보드, 사진, 정밀 편집, 현지화, 비즈니스 자료와 지역 비즈니스 캠페인을 위한 **11개 카테고리, 55개의 독창적인 레시피**를 제공합니다.
